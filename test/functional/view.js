...
function getItem(idx) {
    ...
    if ((li = document.querySelectorAll('[data-minicart-role=minicart-item]')[idx])) {

        attrsList = li.querySelectorAll('[data-minicart-role=minicart-attributes]')[0];
...
describe('View', function () {
    ...
    it('should update products via the UI', function (done) {
        ...
        input = document.querySelectorAll('[data-minicart-role=minicart-quantity]')[0];
        input.value = 3;
    ...
    it('should update when a product is removed', function () {
        ...
        fakeEvent(document.querySelectorAll('[data-minicart-role=minicart-remove]')[0], 'click');
        assert(getItem(0) === false);
    });
    ...
    it('should have a checkout button with items', function () {
        ...
        cart = document.getElementById(config.name);
        button = cart.querySelectorAll('[data-minicart-role=minicart-submit]')[0];
